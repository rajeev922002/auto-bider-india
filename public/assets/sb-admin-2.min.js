...
$(document).ready(function () {
  $(".admin-alert .alert").on("close.bs.alert", function () {
    var btn = $(this).parents(".admin-alert");
    jQuery.ajax({
      type: "POST",
      url: "hide_alert.php",
  ...
  $(".btn-onboarding-show-more").click(function () {
    $(this).parent().remove();
    $(".").removeClass("");
  });
  $(".setting-collpase-btn").click(function () {
    if ($(".setting-sidebar").hasClass("open")) {
      $(this).html("Show Settings Menu");
    } else {
      $(this).html("Hide Settings Menu");
    }
    $(".setting-sidebar").toggleClass("open");
  });
});
